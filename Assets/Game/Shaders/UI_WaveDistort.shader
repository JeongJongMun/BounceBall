// UI 이미지 UV를 사인파로 살짝 흔들어 물결(디스토션)처럼 보이게 한다.
Shader "UI/WaveDistort"
{
    Properties
    {
        [PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
        _Color ("Tint", Color) = (1, 1, 1, 1)
        _WaveAmplitude ("Wave Amplitude", Range(0, 0.1)) = 0.018
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                uv.x += sin(uv.x * _WaveFrequency * 0.5 + t * 0.7) * _WaveAmplitude * 0.25;
